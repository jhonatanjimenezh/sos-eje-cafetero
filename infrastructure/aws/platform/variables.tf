...
variable "sync_batch_requests_per_minute" {
  ...
  default = 30
  validation {
    condition     = var.sync_batch_requests_per_minute >= 5 && var.sync_batch_requests_per_minute <= 300
    error_message = "sync_batch_requests_per_minute debe estar entre 5 y 300."
  }
}
